...
const modulePath = path.join('js', 'modules', 'appointment-edit.js');
const scriptTag = '<script src="js/modules/appointment-edit.js"></script>';
const names = [
...
if (!html.includes(scriptTag)) {
  const anchor = '<script src="js/modules/appointment-create.js"></script>';
...
console.log(`Fase 6B2 aplicada: ${names.length} funciones trasladadas a ${modulePath}.`);
