...
for (const token of ['Semana 3 — aviso previo','Readaptación Funcional','Historial de seguimientos']) {
  assert(followSource.includes(token) || token === 'Historial de seguimientos', `Falta el flujo de seguimiento: ${token}.`);
}
