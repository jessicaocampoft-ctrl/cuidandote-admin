# Inventario focal de Agenda — Fase 6A

- Funciones relacionadas: 38
- Funciones con escritura detectada: 1
- IDs relacionados: 26
- Handlers relacionados: 26

## Funciones candidatas de lectura/renderizado

- `loadProfessionalAgenda` — línea 6978
- `renderProfessionalAgenda` — línea 6990
- `_runUrlRepairIfRequested` — línea 7084
- `goAgendaPatient` — línea 7599
- `agendarHoy` — línea 7893
- `confirmarPago` — línea 7940
- `exportarAgendaDia` — línea 7987
- `submitAdminBookingMulti` — línea 8256
- `toggleReagendar` — línea 8388
- `confirmarReagendar` — línea 8392
- `filtrarDia` — línea 8441
- `smartAgendaFilter` — línea 8727
- `globalSearch` — línea 9155
- `renderAgenda` — línea 9178
- `clearFilters` — línea 9319
- `filtrarHoy` — línea 9326
- `agendarDesdePaciente` — línea 9374
- `changeStatus` — línea 9403
- `confirmarCancelacion` — línea 9523
- `guardarEdicion` — línea 9664
- `submitEvento` — línea 10280
- `eliminarEvento` — línea 10329
- `eeeGuardar` — línea 10396
- `eeeEliminar` — línea 10440
- `submitAdminBooking` — línea 10453
- `exportarHistorialPaciente` — línea 10911
- `calPrev` — línea 11374
- `calNext` — línea 11375
- `calToday` — línea 11376
- `renderCalendar` — línea 11380
- `agendarDesdePacienteRec` — línea 11937
- `agendarDesdeSeg` — línea 12289
- `exportarSeguimientoCSV` — línea 12323
- `renderMetricas` — línea 16273
- `marcarTodasAtendidas` — línea 16722
- `setModoIngresos` — línea 16876
- `renderCitasResumen` — línea 16892
...
- `mobBtn-calendario`
- `modalProAgendaAdmin`
- `msgChip-reagendamiento`
- `nuevaCitaCanal`
- `payCitaId`
- `proAgendaAdminContent`
- `proAgendaAdminSummary`
- `proAgendaAdminTitle`
- `proAgendaList`
- `proIssueCitaId`
- `reagendarPanel_${c.id}`
- `sb-agenda`
- `sb-calendario`
- `toggleCita`
- `vAgenda`
...
- `_agendaPage++;renderAgenda(true)`
- `_agendaPage--;renderAgenda(true)`
- `_verCobrosPendientesSemana()`
- `abrirPagoCita(`
- `abrirReporteMes()`
...
- `exportarAgendaDia()`
- `goAgendaPatient(`
- `if(event.target===this)cerrarReporteMes()`
- `imprimirReporteMes()`
- `limpiarCitasSinHora()`
- `loadProfessionalAgenda()`
- `markAutomationMessage(`
- `openNuevaCitaFromCal(`
- `renderAgenda()`
- `renderCitasResumen();renderIngresosDetalle()`
- `toggleReagendar(`
